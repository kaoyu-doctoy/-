...
#define APP_MISSION_POSE_TIMEOUT_MS (500U)
#define APP_MISSION_START_TRANSIT_TIMEOUT_MS (10000U)
#define APP_MISSION_START_SETTLE_MS (3000U)
#define APP_MISSION_START_TRANSIT_SPEED_MPS (0.15f)
#define APP_MISSION_LEVEL_COUNT (3U)
